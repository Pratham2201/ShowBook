//
//  CollectionGridFlowLayout.swift
//  MARKETS
//
//  Created by Parshwanath Chougule on 08/09/20.
//
...
final class CollectionGridFlowLayout: UICollectionViewLayout {

    var numberOfColumns = 0
    var shouldPinFirstColumn = true
    var shouldPinFirstRow = true
    var firstColumnMaxSize:CGSize = CGSize(width: 0.0, height: 0.0)
    var dataRowMaxSize:CGSize = CGSize(width: 0.0, height: 0.0)
    ...
    override func layoutAttributesForItem(at indexPath: IndexPath) -> UICollectionViewLayoutAttributes? {
       ...
       // return itemAttributes[indexPath.section][indexPath.row > 0  ?indexPath.row-1 :indexPath.row]
...
// MARK: - Helpers
extension CollectionGridFlowLayout {
    ...
    func sizeForItemWithColumnIndex(_ columnIndex: Int) -> CGSize {
        ...
        switch columnIndex {
        case 0:
            return firstColumnMaxSize

        default:
            return dataRowMaxSize
        }
